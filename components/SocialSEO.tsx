...
export function generateSocialMetaTags(config: {
  ...
  return {
    ...
    'twitter:site': '@runrisenation',
    'twitter:creator': '@runrisenation',
    'twitter:domain': 'runrisenation.com',

    // Additional Social Meta Tags
    'twitter:app:name:iphone': 'RunRise Nation',
    'twitter:app:name:ipad': 'RunRise Nation',
    'twitter:app:name:googleplay': 'RunRise Nation',
    'twitter:app:url:iphone': fullUrl,
    'twitter:app:url:ipad': fullUrl,
    'twitter:app:url:googleplay': fullUrl,

    // LinkedIn specific
    'linkedin:owner': 'runrisenation',
...
export function SocialShareButtons({ 
  ...
  title, 
  description, 
  hashtags = ['RunRiseNation', 'Running', 'Fitness', 'Bangladesh'] 
}: {
  url: string
  title: string
  description: string
  ...
  const shareLinks = {
    ...
    pinterest: `https://pinterest.com/pin/create/button/?url=${encodedUrl}&media=${encodeURIComponent('https://runrisenation.com/assets/img/nnr_20250525084451.jpg')}&description=${encodedDescription}`,
  }
  ...
  return (
    <div className="flex flex-wrap gap-2 mt-4">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-400 rounded-lg hover:bg-blue-500 transition-colors"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 transition-colors"
